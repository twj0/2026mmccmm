...
2. Smoke run
    ...
    - include appendix-only showcase outputs: `uv run python run_all.py --showcase`
...
- `docs/project_document/showcase.md` (appendix-only showcase module)
...
## Showcase (Appendix-only) Artifacts

- Showcase outputs are written under:
  - `outputs/tables/showcase/`
- Current showcase tables (appendix-only; reproducible generation):
